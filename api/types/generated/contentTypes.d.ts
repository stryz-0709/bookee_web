...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['Home', 'Company']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::book.book'> &
      Schema.Attribute.Private;
    num_of_page: Schema.Attribute.Integer;
    ...
    total_sold: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['Momo', 'Bank', 'Cash']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    browsingHistory: Schema.Attribute.Relation<'oneToMany', 'api::book.book'>;
    ...
    userRole: Schema.Attribute.Enumeration<['User', 'Admin', 'Publisher']>;
    wishlist: Schema.Attribute.Relation<'oneToMany', 'api::book.book'>;
  };
}
